...
employees_df[EmployeeBonus.BONUS] = employees_df[Employee.SKILLSET].apply(lambda skillsets: 8 if FINANCE in skillsets else 4)

employees_bonus_df = EmployeeBonusSchema.validate(employees_df, lazy=True)
